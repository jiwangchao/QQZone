...
<title>个人中心</title>
	...
	<!-- jumping time -->
	<link rel='stylesheet prefetch'  href="${ctx}/css/csshake.min.css">
	...
	<style type="text/css">
		...
		.clock div {
			position: relative;
			float: left;
			background: url(${ctx}/img/menu_bg2.png);
			border-radius: 6px;
			width: 96px;
			height: 80px;
			line-height: 80px;
	...
	<script src="${ctx}/js/datouwang.js"></script>
	<script type="text/javascript">
		function sendTalk(){
			...
			if(talkTextArea == ""){
				...
				$.ajax({
		              url:"${pageContext.request.contextPath}/talk/addOneTalk.action",   
		              type: "POST",
		              ...
		              success: function(data) {
		              	if(data == '0'){
		              			//alert("发表成功");
		              			window.location.href="${pageContext.request.contextPath}/talk/queryMyTalkList.action";
		              		}else{
		              			alert("发表失败！");
		              		}
		              }
	...
	<!-- 顶部一级菜单 -->
		<div id="nav">
			...
			<ul id="menu">
				...
				<li class="onselect"><a href="${ctx}/log/personalZone.action" class="glyphicon glyphicon-star">&nbsp;个人中心</a></li>
				            ...
				            <div class="content">
				                <div class="main">
				                    <p class="txt">
				                        ...
				                        <span class="user">${list.userName }：</span>${list.talkContent }
				                    </p>
